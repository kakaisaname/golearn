...
func main() {
	...
	inputReadBuf2 := strings.NewReader("中文1234567890")
	reader2 := bufio.NewReader(inputReadBuf2)
	//读取一个字节
	b2, _ := reader2.ReadByte() //ä
	...
	fmt.Println(string(b3),size) //中 3
	...
	writer10.Flush()
	fmt.Println(writer10.Available(), writer10.Buffered(), b10) //4096 0 1234567890
